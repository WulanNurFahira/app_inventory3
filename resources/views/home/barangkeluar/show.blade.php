      ...
      <div class="container-fluid">
        <div class="row col-12">
          <div class="col-12">
            ...
            <h1>Detail Produk {{ $barangkeluar->barang->nama_barang }}</h1></center>
          </div>
          <div class="col-12">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <center></center><h1 class="profile-username text-center">{{$barangkeluar->barang->nama_barang}}</h1>

                <p class="text-muted text-center">Taekwondo Store</p>

                <ul class="list-group list-group-unbordered mb-12">
                  <li class="list-group-item">
                    <b>Jumlah Stok</b> <h3 class="profile-username text-center">{{$barangkeluar->barang->stok}}</h3>
                  </li>
                  <li class="list-group-item">
                    <b>Nama Supplier</b> <h3 class="profile-username text-center">{{$barangkeluar->nama_supplier}}</h3>
                  </li>
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
                ...
                <p class="text-muted">{{$barangkeluar->barang->nama_barang}}Adalah Sebuah Perlengkapan wajib yang harus dimiliki oleh Atlet TAEKWONDO Poomsae maupun Kyourugi, Perlengkapan yang harus siap sedia disaat atlet sedang bertanding</p>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
